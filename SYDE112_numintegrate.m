function sum = numintegrate(x_low,x_hi,numint,typeint)

%Numerical Integrator created by Alex Shum
...
% f:        The function we're interested in integrating. Not so much an
%           input, but go edit the f.m file that comes with it.
